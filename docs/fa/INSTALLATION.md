...
این سند مراحل نصب رسمی IVA Panel را توضیح می‌دهد. پیش از شروع، فقط از لینک‌های رسمی داخل [README](../../README.md) استفاده کنید.
...
3. توکن را فقط در رابط رسمی‌ای وارد کنید که ربات باز می‌کند؛ توکن را به‌صورت پیام Telegram ارسال نکنید.
...
به [install.ivaworks.site](https://install.ivaworks.site/) بروید، آدرس را دقیق بررسی کنید و مراحل نمایش‌داده‌شده را ادامه دهید. درخواست نصب مستقیماً از دستگاه شما به Cloudflare ارسال می‌شود و توکن در سرور، پایگاه داده یا Telegram متعلق به IVA ذخیره یا عبور داده نمی‌شود. اگر سایت در دسترس نبود، فرایند رسمی را از [@IVAPANELBOT](https://t.me/IVAPANELBOT) آغاز کنید.

جزئیات معماری و عدم ذخیره‌سازی اطلاعات در [سیاست حریم خصوصی](../../PRIVACY.md) آمده است.
